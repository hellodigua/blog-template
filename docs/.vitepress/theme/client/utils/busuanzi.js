...
bszCaller = {
  fetch: function (t, e) {
    ...
    scriptTag = document.createElement("SCRIPT"), scriptTag.type = "text/javascript", scriptTag.defer = !0, scriptTag.rel = "unsafe-url", scriptTag.referrerPolicy = "no-referrer-when-downgrade", scriptTag.src = t, document.getElementsByTagName("HEAD")[0].appendChild(scriptTag);
